...
> **S05A + S07 + S08A + S10 + S12 + S13 + S16 + S20 + S21 + S22 + S25 + S26 + S28 + S29 + S30 + S31 + S32 + S33 + S34 + S35 = PRODUCTION / GREEN**
>
> **S15A MPA = Manual P0 canonical source / operator-driven / no unattended scheduling**

SignalForge has now proven twenty automated source/domain shapes under the same v1.5 acquisition lifecycle, plus the separate S15A Manual P0 canonical path:
