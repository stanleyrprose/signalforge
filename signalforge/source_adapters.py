...
ADAPTERS = {
    "mpt": SourceAdapter(
        ...
        detail_parser_version="mpt-v4",
        normalizer_version="mpt-normalize-v2",
    ...
    "industry_tender": SourceAdapter(
        ...
        detail_parser_version="industry-announcement-detail-v2",
        normalizer_version="industry-tender-normalize-v2",
    ...
    "energy_tender": SourceAdapter(
        ...
        detail_parser_version="energy-html-plus-text-pdf-v2",
    ...
    "mofa_tender": SourceAdapter(
        ...
        detail_parser_version="mofa-wordpress-html-optional-text-pdf-v3",
